                            ...
                            <div className="filter row portfolio-feed">
                                <TabPanel className="row">
                                    {projects.map((project, index) => {
                                        return (
                                            <div className="flash grid-item-p element-item transition creative col-md-6" data-category="transition">
...
export default ProjectStandardSection;
