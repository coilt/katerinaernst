              ...
              <Tab.Panel className=" flex justify-center">
                <div className="w-[600px]">
                  <p className={`my-4 ${paragraphFont.className}`}>
                    ...
                    German photographer Yva (Elsie Neuländer Simon) from 1936.
                    The increasingly oppressive restrictions placed on Jews by
                    the Nuremberg laws meant that his father lost control of the
                    factory in which he manufactured buttons and buckles; he was
                    briefly interned in a concentration camp on Kristallnacht, 9
                    November 1938, which finally compelled the family to leave
                    Germany. Newton's parents fled to Argentina. Newton was
                    issued with a passport just after turning 18 and left
                    Germany on 5 December 1938. At Trieste, he boarded the Conte
                    Rosso (along with about 200 others escaping the Nazis),
                    intending to journey to China. After arriving in Singapore,
                    Newton found he was able to remain there, first briefly as a
                    photographer for the Straits Times and then as a portrait
                    photographer.
                  </p>
                  ...
                  <p className={` my-4 ${paragraphFont.className}`}>
                    ...
                    and Harper's Bazaar. He established a particular style
                    marked by erotic, stylised scenes, often with
                    sado-masochistic and fetishistic subtexts. A heart attack in
                    1970 reduced Newton's output, nevertheless his wife's
                    encouragement led to his profile continuing to expand,
                    especially with a big success, the 1980 studio-bound stark
                    infinity of the "Big Nudes" series. His "Naked and Dressed"
                    portfolio followed and in 1992 "Domestic Nudes" which marked
                    the pinnacle of his erotic-urban style, these series all
                    underpinned with the prowess of his technical skills. Newton
                    also worked in portraiture and more fantastical studies.
                    Newton shot a number of pictorials for Playboy, including
                    pictorials of Nastassja Kinski and Kristine DeBell. Original
                    prints of the photographs from his August 1976 pictorial of
                    DeBell, "200 Motels, or How I Spent My Summer Vacation" were
                    sold at auctions of Playboy archives by Bonhams in 2002 for
                    $21,075, and by Christie's in December 2003 for $26,290.
                    "Three Boys from Pasadena" In 2009, June Browne
                    conceptualised a tribute exhibition to Newton, based on
                    three photographers that befriended Newton in Los Angeles in
                    1980: Mark Arbeit, Just Loomis, and George Holz. All three
                    had been photography students at The Art Center College of
