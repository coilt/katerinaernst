                ...
                <Tab.Panel className=" flex justify-center">
                  <div className="w-[600px] ">
                    ...
                    <p className={`my-4 ${paragraphFont.className}`}>
                      Ever since I've picked up the camera for the first time
                      many years ago, it has been my goal to capture what even
                      the eye can't see. To me it is not just important, it's
                      the whole point — to grasp the unsayable, the unseeable.
                      Every time I peer through the viewfinder or into the
                      control monitor, I'm striving to seize not just image, but
                      the feeling, the emotion itself.
                    </p>
                    <p className={`my-4 ${paragraphFont.className}`}>
